...
export const Animations = () =>{
        ...
        const categories:[string, Movie[]][] = [[ "Action & Adventure ", actionContent], ["Mystery", mysteryContent],["Crime", crimeContent], ["Reality", realityContent], ["Science Fiction ", fictionContent], ["Comedy ", comedyContent], ["War ", warContent], ["Romance ", romanceContent],["Drama", dramaContent], ["History ", historyContent], ["Documentary", documentaryContent]]

        useEffect(() =>{
            async function LoadData(){
                // setPopularContent(await fetchTrendingMediaType("tv/popular"));
                setActionContent(await fetchAnimationByGenres(10759));
